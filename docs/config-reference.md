...
| `presigned_ttl` | ❌ | `3600` | Presigned URL expiry in seconds, capped at 604800 (7 days) and never raised, except that `0` becomes `1` because S3 rejects `X-Amz-Expires=0` |
