...
async fn process_line_webhook_events(
    ...
    for event in webhook_body.events {
        ...
        if should_drop_group_message(
            &gateway_event.channel.channel_type,
            &gateway_event.content.text,
...
mod tests {
    ...
    async fn webhook_acknowledges_before_async_event_forwarding() {
        ...
        let state = Arc::new(crate::AppState {
            ...
            line_group_mention_keyword: None,
            teams: None,
    ...
    #[test]
    fn drop_empty_keyword_treated_as_unset() {
        assert!(!should_drop_group_message("group", "anything", Some("")));
    }

    #[test]
    fn drop_keyword_match_is_substring_and_case_sensitive() {
